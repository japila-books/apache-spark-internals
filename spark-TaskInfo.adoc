...
`TaskInfo` is information about a running task attempt inside a link:spark-taskscheduler-TaskSet.adoc[TaskSet].
...
* [[taskId]] Task ID
* [[index]] Index of the task within its link:spark-taskscheduler-TaskSet.adoc[TaskSet] that may not necessarily be the same as the ID of the RDD partition that the task is computing.
