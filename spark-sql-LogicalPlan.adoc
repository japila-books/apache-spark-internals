...
=== [[computeStats]] Statistics Estimates (of All Child Logical Plans) -- `computeStats` method
...
NOTE: `computeStats` is used exclusively when `LogicalPlan` <<stats, is requested for plan statistics estimates>>.
