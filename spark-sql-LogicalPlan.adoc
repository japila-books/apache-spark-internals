== [[LogicalPlan]] LogicalPlan -- Logical Query Plan

`LogicalPlan` is a  link:spark-sql-catalyst-QueryPlan.adoc[QueryPlan] that corresponds to a logical operator being a structured query in Spark SQL.
