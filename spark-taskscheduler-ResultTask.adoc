...
`ResultTask` is a link:spark-taskscheduler-Task.adoc[Task] that <<runTask, executes a function on the records in a RDD partition>>.
...
NOTE: `preferredLocations` is part of link:spark-taskscheduler-Task.adoc#contract[Task contract].
...
NOTE: `runTask` is part of link:spark-taskscheduler-Task.adoc#contract[Task contract] to run a task.
...
`runTask` records link:spark-taskscheduler-Task.adoc#_executorDeserializeTime[_executorDeserializeTime] and link:spark-taskscheduler-Task.adoc#_executorDeserializeCpuTime[_executorDeserializeCpuTime] properties.
