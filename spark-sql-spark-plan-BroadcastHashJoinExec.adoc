...
`BroadcastHashJoinExec` is a link:spark-sql-catalyst-SparkPlan.adoc#BinaryExecNode[binary physical operator] with link:spark-sql-whole-stage-codegen.adoc#CodegenSupport[CodegenSupport].
