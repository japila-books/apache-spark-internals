...
`Pool` is a link:spark-taskscheduler-schedulable.adoc[Schedulable] entity that represents collection of (other) `Pools` or link:spark-tasksetmanager.adoc[TaskSetManagers].
