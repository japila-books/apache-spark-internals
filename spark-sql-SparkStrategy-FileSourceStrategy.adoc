...
`FileSourceStrategy` is a `Strategy` of link:spark-sql-SparkPlanner.adoc[SparkPlanner]. It <<PhysicalOperation, destructures>> and then optimizes a link:spark-sql-LogicalPlan.adoc[LogicalPlan].
