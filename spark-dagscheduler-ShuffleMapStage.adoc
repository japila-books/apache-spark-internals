...
NOTE: `findMissingPartitions` is a part of link:spark-DAGScheduler-Stage.adoc#contract[`Stage` contract] that returns the partitions that are missing, i.e. are yet to be computed.
