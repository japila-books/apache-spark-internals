...
* <<initialize, Initializing tabs>>, i.e. link:spark-webui-jobs.adoc#creating-instance[JobsTab], link:spark-webui-StagesTab.adoc#creating-instance[StagesTab], link:spark-webui-StorageTab.adoc#creating-instance[StorageTab], link:spark-webui-environment.adoc#creating-instance[EnvironmentTab]
...
3. link:spark-webui-StorageTab.adoc[StorageTab]
