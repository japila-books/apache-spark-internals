...
.. link:spark-streaming/spark-streaming-kafka-KafkaUtils.adoc[KafkaUtils -- Creating Kafka Streams and RDDs]
.. link:spark-streaming/spark-streaming-kafka-DirectKafkaInputDStream.adoc[DirectKafkaInputDStream]
