...
. link:spark-scheduler-Task.adoc[Tasks]
.. link:spark-scheduler-ShuffleMapTask.adoc[ShuffleMapTask -- Task for ShuffleMapStage]
.. link:spark-scheduler-ResultTask.adoc[ResultTask]
...
. link:spark-shuffle-ShuffleManager.adoc[ShuffleManager -- Pluggable Shuffle Systems]
...
.. link:spark-SparkListener-EventLoggingListener.adoc[EventLoggingListener -- Spark Listener for Persisting Events]
