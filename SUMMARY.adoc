...
. Physical Plan Preparations
.. link:spark-sql-CollapseCodegenStages.adoc[CollapseCodegenStages Physical Plan Preparation]
.. link:spark-sql-EnsureRequirements.adoc[EnsureRequirements Physical Plan Preparation]
