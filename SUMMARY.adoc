...
... link:spark-sql-spark-plan-ShuffleExchange.adoc[ShuffleExchange Physical Operator (and ShuffledRowRDD)]
...
.. link:spark-taskscheduler-tasksets.adoc[TaskSet -- Set of Tasks (for Partition)]
...
. link:spark-shuffle-manager.adoc[ShuffleManager -- Shuffle System Manager]
