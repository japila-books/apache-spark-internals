...
=== Spark on Local Cluster Manager
...
.. link:spark-taskscheduler-TaskSet.adoc[TaskSet -- Set of Tasks for Stage]
...
... link:spark-taskscheduler-SchedulableBuilder.adoc[Schedulable Builders]
... link:spark-taskscheduler-SchedulableBuilder.adoc[SchedulableBuilder]
