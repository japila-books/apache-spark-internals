...
. link:structured-streaming/spark-sql-structured-streaming.adoc[Structured Streaming -- Streaming Datasets]
. link:structured-streaming/spark-sql-streaming-DataStreamReader.adoc[DataStreamReader]
. link:structured-streaming/spark-sql-streaming-DataStreamWriter.adoc[DataStreamWriter]

. link:structured-streaming/spark-sql-streaming-source.adoc[Streaming Sources]
.. link:structured-streaming/spark-sql-streaming-FileStreamSource.adoc[FileStreamSource]
.. link:structured-streaming/spark-sql-streaming-KafkaSource.adoc[KafkaSource]
.. link:structured-streaming/spark-sql-streaming-MemoryStream.adoc[MemoryStream]
.. link:structured-streaming/spark-sql-streaming-TextSocketSource.adoc[TextSocketSource]

. link:structured-streaming/spark-sql-streaming-sink.adoc[Streaming Sinks]
.. link:structured-streaming/spark-sql-streaming-ConsoleSink.adoc[ConsoleSink]
.. link:structured-streaming/spark-sql-streaming-ForeachSink.adoc[ForeachSink]

. link:structured-streaming/spark-sql-streaming-StreamSourceProvider.adoc[StreamSourceProvider -- Streaming Source Provider]
.. link:structured-streaming/spark-sql-streaming-KafkaSourceProvider.adoc[KafkaSourceProvider]
.. link:structured-streaming/spark-sql-streaming-TextSocketSourceProvider.adoc[TextSocketSourceProvider]
. link:structured-streaming/spark-sql-streaming-StreamSinkProvider.adoc[StreamSinkProvider]
. link:structured-streaming/spark-sql-streaming-StreamingQueryManager.adoc[StreamingQueryManager]
. link:structured-streaming/spark-sql-streaming-StreamingQuery.adoc[StreamingQuery]
. link:structured-streaming/spark-sql-streaming-trigger.adoc[Trigger]
. link:structured-streaming/spark-sql-streaming-streamexecution.adoc[StreamExecution]
. link:structured-streaming/spark-sql-streaming-streamingrelation.adoc[StreamingRelation]
. link:structured-streaming/spark-sql-streaming-StreamingQueryListenerBus.adoc[StreamingQueryListenerBus]
. link:structured-streaming/spark-sql-streaming-MemoryPlan.adoc[MemoryPlan Logical Query Plan]
