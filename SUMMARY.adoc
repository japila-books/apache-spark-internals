...
.. link:spark-listeners.adoc[DAGScheduler Listeners]
...
.. link:exercises/spark-exercise-custom-scheduler-listener.adoc[Developing Custom DAGScheduler Listener to monitor DAGScheduler in Scala]
