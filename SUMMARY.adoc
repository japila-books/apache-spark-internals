...
. link:spark-sql-SparkPlan.adoc[SparkPlan -- Query Execution Plan / Physical Operator]
.. link:spark-sql-SparkPlan-BroadcastExchangeExec.adoc[BroadcastExchangeExec Unary Operator for Broadcast Joins]
...
. link:spark-sql-SQLMetrics.adoc[SQLMetrics]
