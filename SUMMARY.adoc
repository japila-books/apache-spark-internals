...
... link:spark-streaming-dstreams.adoc[DStreams]
.... link:spark-streaming-inputdstreams.adoc[InputDStreams]
...
... link:spark-streaming-kafka.adoc[Data Ingestion using Apache Kafka]
