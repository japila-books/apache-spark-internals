...
.. link:spark-sql-LogicalPlan-BroadcastHint.adoc[BroadcastHint Logical Operator]
...
. link:spark-sql-Optimizer.adoc[Optimizer -- Logical Query Plan Optimizer]
.. link:spark-sql-Optimizer-PushDownPredicate.adoc[PushDownPredicate -- Predicate Pushdown / Filter Pushdown]
.. link:spark-sql-Optimizer-CombineTypedFilters.adoc[Combine Typed Filters]
.. link:spark-sql-Optimizer-PropagateEmptyRelation.adoc[Propagate Empty Relation]
.. link:spark-sql-Optimizer-SimplifyCasts.adoc[Simplify Casts]
.. link:spark-sql-Optimizer-ColumnPruning.adoc[Column Pruning]
...
.. link:spark-sql-Optimizer-EliminateSerialization.adoc[Eliminate Serialization]
