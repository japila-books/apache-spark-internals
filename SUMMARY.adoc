...
... link:spark-taskscheduler-ShuffleMapTask.adoc[ShuffleMapTask]
... link:spark-taskscheduler-ResultTask.adoc[ResultTask]

.. link:spark-MapStatus.adoc[MapStatus]
...
. link:spark-blockmanager.adoc[Block Manager -- Key-Value Store for Blocks]
...
. link:spark-ShuffleManager.adoc[ShuffleManager -- Shuffle System Manager]
...
... link:spark-UnsafeShuffleWriter.adoc[UnsafeShuffleWriter]

.. link:spark-BypassMergeSortShuffleHandle.adoc[BypassMergeSortShuffleHandle]
.. link:spark-SerializedShuffleHandle.adoc[SerializedShuffleHandle]
