...
.. link:spark-sql-SparkStrategy-Aggregation.adoc[Aggregation Strategy]
...
.. link:spark-sql-catalyst-Attribute.adoc[Attribute]
.. link:spark-sql-Generator.adoc[Generator]
.. link:spark-sql-JsonToStructs.adoc[JsonToStructs]
.. link:spark-sql-Literal.adoc[Literal]
...
.. link:spark-sql-LogicalPlan-Repartition-RepartitionByExpression.adoc[Repartition and RepartitionByExpression Logical Operators]
...
. link:spark-sql-SparkOptimizer.adoc[SparkOptimizer -- Query Optimizer]
...
.. link:spark-sql-SparkPlan-BroadcastHashJoinExec.adoc[BroadcastHashJoinExec Physical Operator]
.. link:spark-sql-SparkPlan-BroadcastNestedLoopJoinExec.adoc[BroadcastNestedLoopJoinExec Physical Operator]
.. link:spark-sql-SparkPlan-CoalesceExec.adoc[CoalesceExec Physical Operator]
...
.. link:spark-sql-SparkPlan-ShuffleExchange.adoc[ShuffleExchange Physical Operator]
.. link:spark-sql-SparkPlan-WindowExec.adoc[WindowExec Physical Operator]
