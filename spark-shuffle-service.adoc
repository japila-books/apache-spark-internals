...
A *Shuffle Service* is a Spark service that is network-addressable, i.e. runs on a separate host and port, to register link:spark-scheduler.adoc#ShuffleMapStage[shuffle dependencies for ShuffleMapStage] and ...FIXME
