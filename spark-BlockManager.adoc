...
* `BypassMergeSortShuffleWriter` is requested to <<spark-BypassMergeSortShuffleWriter.adoc#write, write records>>

* `ShuffleExternalSorter` is requested to <<spark-ShuffleExternalSorter.adoc#writeSortedFile, writeSortedFile>>
