...
| [[spark_driver_blockManager_port]] `spark.driver.blockManager.port` | link:spark-blockmanager.adoc#spark_blockManager_port[spark.blockManager.port] | Port to use for the link:spark-blockmanager.adoc[block managed] on the driver.
