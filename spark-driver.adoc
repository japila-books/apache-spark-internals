...
It is the cockpit of jobs and tasks execution (using link:spark-scheduler-DAGScheduler.adoc[DAGScheduler] and link:spark-scheduler-TaskScheduler.adoc[Task Scheduler]). It hosts link:spark-webui.adoc[Web UI] for the environment.
...
* Launches link:spark-scheduler-Task.adoc[tasks]
