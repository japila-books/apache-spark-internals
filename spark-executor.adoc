...
*Coarse-grained executors* are executors that use link:spark-executor-backends.adoc#CoarseGrainedExecutorBackend[CoarseGrainedExecutorBackend] for task scheduling.
