...
| [[spark.executor.cores]][[spark_executor_cores]] `spark.executor.cores` | | Number of cores for an executor.

| [[spark.executor.extraClassPath]][[spark_executor_extraClassPath]] `spark.executor.extraClassPath`
|
| List of URLs representing a user-defined CLASSPATH.

Each entry is separated by system-dependent path separator, i.e. `:` on Unix/MacOS systems and `;` on Microsoft Windows.

| [[spark.executor.extraJavaOptions]][[spark_executor_extraJavaOptions]] `spark.executor.extraJavaOptions`
|
...
| [[spark.executor.extraLibraryPath]][[spark_executor_extraLibraryPath]] `spark.executor.extraLibraryPath`
|
...
| [[spark.executor.instances]][[spark_executor_instances]] `spark.executor.instances`
| `0`
| Number of executors to use.

NOTE: A positive value disables link:spark-dynamic-allocation.adoc[dynamic allocation].
