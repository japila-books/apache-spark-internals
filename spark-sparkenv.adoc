...
[[ShuffleManager]]
It creates a link:spark-shuffle-manager.adoc[ShuffleManager] based on link:spark-shuffle-manager.adoc#spark_shuffle_manager[spark.shuffle.manager] Spark property.
