...
Encoders know the link:spark-sql-dataframe-structtype.adoc[schema] of the records. They allow for significantly faster serialization and deserialization (comparing to the default Java or Kryo serializers).
