...
NOTE: `Expression` is often called *Catalyst's expression*, but I consider `Expression` to be _merely_ built using the link:spark-sql-catalyst.adoc[Catalyst -- Tree Manipulation Framework].
