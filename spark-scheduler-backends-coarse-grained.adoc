...
`start` initializes the internal `driverEndpoint` RPC endpoint to be a <<DriverEndpoint, DriverEndpoint>> object registered under the name of *CoarseGrainedScheduler*.
