...
The number of free cores of the executor for the task is decremented (by link:spark-taskscheduler.adoc#settings[spark.task.cpus]) and link:spark-executor-backends-coarse-grained.adoc#messages[LaunchTask] message is sent to it.
