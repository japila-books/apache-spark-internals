...
`org.apache.spark.sql.functions` object offers many functions to work with link:spark-sql-columns.adoc[Columns] in Datasets.
...
[align="center",width="100%",frame="topbot",options="header"]
|======================
