...
[[standard-functions]]
.Standard Functions in Spark SQL
...
NOTE: `grouping` can only be used with link:spark-sql-aggregation-rollup-cube.adoc#cube[cube], link:spark-sql-aggregation-rollup-cube.adoc#rollup[rollup] or `GROUPING SETS` aggregate operators (and is verified when link:spark-sql-Analyzer-CheckAnalysis.adoc#Grouping[`Analyzer` does check analysis]).
...
=== [[grouping_id]] `grouping_id` Function
...
NOTE: `grouping_id` can only be used with link:spark-sql-aggregation-rollup-cube.adoc#cube[cube], link:spark-sql-aggregation-rollup-cube.adoc#rollup[rollup] or `GROUPING SETS` aggregate operators (and is verified when link:spark-sql-Analyzer-CheckAnalysis.adoc#GroupingID[`Analyzer` does check analysis]).
...
+- Aggregate [city#40, year#41, spark_grouping_id#37], [city#40, year#41, spark_grouping_id#37 AS grouping_id()#36]
   +- Expand [List(city#7, year#8, count#9, city#38, year#39, 0), List(city#7, year#8, count#9, city#38, null, 1), List(city#7, year#8, count#9, null, year#39, 2), List(city#7, year#8, count#9, null, null, 3)], [city#7, year#8, count#9, city#40, year#41, spark_grouping_id#37]
      +- Project [city#7, year#8, count#9, city#7 AS city#38, year#8 AS year#39]
         +- Union
            :- Project [_1#3 AS city#7, _2#4 AS year#8, _3#5 AS count#9]
            :  +- LocalRelation [_1#3, _2#4, _3#5]
            +- Project [_1#17 AS city#21, _2#18 AS year#22, _3#19 AS count#23]
               +- LocalRelation [_1#17, _2#18, _3#19]

== Analyzed Logical Plan ==
city: string, year: int, grouping_id(): int
Sort [city#40 DESC NULLS LAST, year#41 DESC NULLS LAST], true
+- Aggregate [city#40, year#41, spark_grouping_id#37], [city#40, year#41, spark_grouping_id#37 AS grouping_id()#36]
   +- Expand [List(city#7, year#8, count#9, city#38, year#39, 0), List(city#7, year#8, count#9, city#38, null, 1), List(city#7, year#8, count#9, null, year#39, 2), List(city#7, year#8, count#9, null, null, 3)], [city#7, year#8, count#9, city#40, year#41, spark_grouping_id#37]
      +- Project [city#7, year#8, count#9, city#7 AS city#38, year#8 AS year#39]
         +- Union
...
Sort [city#40 DESC NULLS LAST, year#41 DESC NULLS LAST], true
+- Aggregate [city#40, year#41, spark_grouping_id#37], [city#40, year#41, spark_grouping_id#37 AS grouping_id()#36]
   +- Expand [List(city#38, year#39, 0), List(city#38, null, 1), List(null, year#39, 2), List(null, null, 3)], [city#40, year#41, spark_grouping_id#37]
      +- Union
         :- LocalRelation [city#38, year#39]
         +- LocalRelation [city#38, year#39]

== Physical Plan ==
*Sort [city#40 DESC NULLS LAST, year#41 DESC NULLS LAST], true, 0
+- Exchange rangepartitioning(city#40 DESC NULLS LAST, year#41 DESC NULLS LAST, 200)
   +- *HashAggregate(keys=[city#40, year#41, spark_grouping_id#37], functions=[], output=[city#40, year#41, grouping_id()#36])
      +- Exchange hashpartitioning(city#40, year#41, spark_grouping_id#37, 200)
         +- *HashAggregate(keys=[city#40, year#41, spark_grouping_id#37], functions=[], output=[city#40, year#41, spark_grouping_id#37])
            +- *Expand [List(city#38, year#39, 0), List(city#38, null, 1), List(null, year#39, 2), List(null, null, 3)], [city#40, year#41, spark_grouping_id#37]
               +- Union
                  :- LocalTableScan [city#38, year#39]
                  +- LocalTableScan [city#38, year#39]
```
