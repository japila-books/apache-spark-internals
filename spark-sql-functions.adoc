...
NOTE: `grouping` can only be used with link:spark-sql-aggregation-rollup-cube.adoc#cube[cube], link:spark-sql-aggregation-rollup-cube.adoc#rollup[rollup] or `GROUPING SETS` aggregate operators.
...
NOTE: `grouping_id` can only be used with link:spark-sql-aggregation-rollup-cube.adoc#cube[cube], link:spark-sql-aggregation-rollup-cube.adoc#rollup[rollup] or `GROUPING SETS` aggregate operators.
...
scala> workshops
  ...
  .sort($"city".desc_nulls_last, $"year".desc_nulls_last)
  .show
scala> workshops.cube("city", "year").agg(grouping_id()).sort($"city".desc_nulls_last, $"year".desc_nulls_last).show
+-------+----+-------------+
