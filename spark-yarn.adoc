...
=== [[yarn-cluster-scheduler-backend]] YarnClusterSchedulerBackend

This is the only link:spark-execution-model.adoc#scheduler-backends[scheduler backend] that supports *multiple application attempts*.
