...
2. link:../spark-taskschedulerimpl.adoc#speculative-execution[TaskScheduler and Speculative execution of tasks] - 45 mins
3. link:../spark-rpc.adoc#developing-custom-rpcenv[Developing Custom RPC Environment (RpcEnv)] - 45 mins
4. link:../spark-metrics.adoc[Spark Metrics System] - 45 mins
