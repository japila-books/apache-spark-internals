...
* Getting current configuration of a Spark application
** <<env, SparkEnv>>
** <<getConf, SparkConf>>
...
`appName` gives the value of the mandatory link:spark-configuration.adoc#spark.app.name[spark.app.name] setting.
