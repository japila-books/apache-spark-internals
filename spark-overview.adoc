...
Many Machine Learning algorithms require many iterations before the result models get optimal.

Spark caches intermediate data in memory for faster performance.
