...
When you hear *Apache Spark* it can be two things - the Spark engine aka *Spark Core* or the Spark project with Spark Core and the components - Spark SQL, Spark Streaming, Spark MLlib and Spark GraphX.
