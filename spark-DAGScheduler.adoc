...
With no exceptions along the way, `submitMissingTasks` computes a collection of link:spark-taskscheduler-Task.adoc[tasks] to execute for the missing partitions (of the `stage`).
