...
Spark SQL introduces a tabular data abstraction called *DataFrames*. It is designed to ease processing large amount of structured tabular data on Spark infrastructure.
