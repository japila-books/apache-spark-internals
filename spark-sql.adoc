...
Spark SQL allows you to execute SQL-like queries on large volume of data. It can access data from different data sources - files or tables. Spark SQL comes with different interfaces to work with:

1. Scala programmers will likely find Dataset API very appealing.
2. Non-programmers will likely use SQL as their query language.
