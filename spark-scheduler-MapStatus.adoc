...
`MapStatus` is the link:spark-scheduler-ShuffleMapTask.adoc#runTask[result of running a `ShuffleMapTask`] that includes <<contract, information about the `BlockManager` and estimated size of the reduce blocks>>.
