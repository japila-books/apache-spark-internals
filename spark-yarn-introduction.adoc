...
It is a general-purpose application scheduling framework that was aimed at MapReduce but quickly turned itself into supporting non-MapReduce applications equally.
