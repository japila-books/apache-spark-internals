...
`BlockManagerMasterEndpoint` is the xref:rpc:index.adoc#ThreadSafeRpcEndpoint[ThreadSafeRpcEndpoint] for xref:BlockManagerMaster.adoc[BlockManagerMaster] under *BlockManagerMaster* name.
