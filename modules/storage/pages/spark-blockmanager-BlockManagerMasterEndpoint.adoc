...
`BlockManagerMasterEndpoint` is the link:spark-rpc.adoc#ThreadSafeRpcEndpoint[ThreadSafeRpcEndpoint] for xref:BlockManagerMaster.adoc[BlockManagerMaster] under *BlockManagerMaster* name.
