...
`DiskBlockObjectWriter` is a https://docs.oracle.com/javase/8/docs/api/java/io/OutputStream.html[java.io.OutputStream] that xref:ROOT:BlockManager.adoc#getDiskWriter[`BlockManager` offers for writing blocks to disk].
