...
BlockManager registers link:spark-blockmanager-BlockManagerSlaveEndpoint.adoc[BlockManagerSlaveEndpoint] with the input xref:ROOT:spark-rpc.adoc[RpcEnv], itself, and xref:ROOT:MapOutputTracker.adoc[MapOutputTracker] (as `slaveEndpoint`).
