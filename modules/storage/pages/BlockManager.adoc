...
* [[master]] xref:storage:BlockManagerMaster.adoc[]
...
getMatchingBlockIds is used when BlockManagerSlaveEndpoint is requested to xref:storage:spark-blockmanager-BlockManagerSlaveEndpoint.adoc#GetMatchingBlockIds[handle a GetMatchingBlockIds message].
...
replicateBlock is used when BlockManagerSlaveEndpoint is requested to xref:storage:spark-blockmanager-BlockManagerSlaveEndpoint.adoc#receiveAndReply-ReplicateBlock[handle a ReplicateBlock message].
