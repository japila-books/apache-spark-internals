...
NOTE: `removeExecutor` is executed when xref:ROOT:DAGSchedulerEventProcessLoop.adoc#handleExecutorLost[`DAGScheduler` processes `ExecutorLost` event].
