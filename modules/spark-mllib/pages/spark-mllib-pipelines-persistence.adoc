...
They allow you to save and load link:spark-mllib-models.md[models] despite the languages -- Scala, Java, Python or R -- they have been saved in and loaded later on.
