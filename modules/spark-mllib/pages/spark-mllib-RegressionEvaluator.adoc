...
`RegressionEvaluator` is an link:spark-mllib-Evaluator.md[Evaluator] of regression models (e.g. link:spark-mllib-ALS.md[ALS], `DecisionTreeRegressor`, link:spark-mllib-DecisionTreeClassifier.md[DecisionTreeClassifier], `GBTRegressor`, `GBTClassifier`, link:spark-mllib-RandomForestRegressor.md[RandomForestRegressor], link:spark-mllib-RandomForestClassifier.md[RandomForestClassifier], link:spark-mllib-LinearRegression.md[LinearRegression], `RFormula`, `NaiveBayes`, link:spark-mllib-LogisticRegression.md[LogisticRegression], `MultilayerPerceptronClassifier`, `LinearSVC`, link:spark-mllib-GeneralizedLinearRegression.md[GeneralizedLinearRegression]).
