...
* link:spark-mllib-pipelines.md[Pipelines]
...
Spark handles data distribution and makes the huge data available by means of xref:rdd:index.md[RDDs], link:spark-sql-DataFrame.md[DataFrames], and recently link:spark-sql-Dataset.md[Datasets].
...
** a graph algorithm
** Among the first MLlib algorithms built upon link:spark-graphx.md[GraphX].
