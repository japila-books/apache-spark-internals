...
It requires a xref:scheduler:TaskScheduler.adoc[Task Scheduler], link:spark-SparkContext.adoc[Spark context], `mesos://` master URL, and link:spark-security.adoc[Security Manager].
