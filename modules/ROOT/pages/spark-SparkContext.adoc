...
* xref:scheduler:spark-scheduler-ShuffleMapTask.adoc#creating-instance[ShuffleMapTask] and xref:scheduler:spark-scheduler-ResultTask.adoc#creating-instance[ResultTask] are created
