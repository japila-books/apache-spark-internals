...
`createTaskScheduler` creates the <<spark-SchedulerBackend.adoc#, SchedulerBackend>> and the xref:scheduler:TaskScheduler.adoc[TaskScheduler] for the given master URL and deployment mode.
