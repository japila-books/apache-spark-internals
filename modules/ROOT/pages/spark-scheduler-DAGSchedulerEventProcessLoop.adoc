...
For xref:scheduler:spark-scheduler-ResultTask.adoc[ResultTask], the stage is assumed a link:spark-scheduler-ResultStage.adoc[ResultStage].
...
For xref:scheduler:spark-scheduler-ShuffleMapTask.adoc[ShuffleMapTask], the stage is assumed a  link:spark-scheduler-ShuffleMapStage.adoc[ShuffleMapStage].
