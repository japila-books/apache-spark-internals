...
| <<BeginEvent, BeginEvent>> | <<handleBeginEvent, handleBeginEvent>> | xref:scheduler:TaskSetManager.adoc[TaskSetManager] informs `DAGScheduler` that a task is starting (through link:spark-scheduler-DAGScheduler.adoc#taskStarted[taskStarted]).
...
| <<GettingResultEvent, GettingResultEvent>> | |  xref:scheduler:TaskSetManager.adoc[TaskSetManager] informs `DAGScheduler` (through link:spark-scheduler-DAGScheduler.adoc#taskGettingResult[taskGettingResult]) that a task has completed and results are being fetched remotely.
...
NOTE: `GettingResultEvent` is posted to inform `DAGScheduler` (through link:spark-scheduler-DAGScheduler.adoc#taskGettingResult[taskGettingResult]) that a xref:scheduler:TaskSetManager.adoc#handleTaskGettingResult[task fetches results].
...
NOTE: `BeginEvent` is posted to inform `DAGScheduler` (through link:spark-scheduler-DAGScheduler.adoc#taskStarted[taskStarted]) that a xref:scheduler:TaskSetManager.adoc#resourceOffer[`TaskSetManager` starts a task].
