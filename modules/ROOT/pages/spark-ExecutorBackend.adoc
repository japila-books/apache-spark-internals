...
NOTE: `TaskRunner` manages a single individual xref:scheduler:Task.adoc[task] and is managed by an link:spark-Executor.adoc#launchTask[`Executor` to launch a task].
