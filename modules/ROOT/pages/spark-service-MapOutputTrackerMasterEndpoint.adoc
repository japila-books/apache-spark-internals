...
`MapOutputTrackerMasterEndpoint` is a link:spark-rpc-RpcEndpoint.adoc[RpcEndpoint] for xref:ROOT:MapOutputTrackerMaster.adoc[MapOutputTrackerMaster].
...
2. `tracker` -- xref:ROOT:MapOutputTrackerMaster.adoc[MapOutputTrackerMaster]
...
NOTE: `StopMapOutputTracker` is posted when xref:ROOT:MapOutputTrackerMaster.adoc#stop[`MapOutputTrackerMaster` stops].
