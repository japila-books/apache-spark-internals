...
It is the cockpit of jobs and tasks execution (using xref:ROOT:DAGScheduler.adoc[DAGScheduler] and xref:scheduler:TaskScheduler.adoc[Task Scheduler]). It hosts link:spark-webui.adoc[Web UI] for the environment.
