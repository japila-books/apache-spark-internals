...
Used exclusively when `UnsafeShuffleWriter` is requested to xref:shuffle:spark-shuffle-UnsafeShuffleWriter.adoc#open[open] (and creates a xref:shuffle:spark-shuffle-ShuffleExternalSorter.adoc[ShuffleExternalSorter])
