...
* `Executor` link:spark-Executor.adoc#creating-instance[is created] (in non-local mode and xref:ROOT:BlockManager.adoc#initialize[requests `BlockManager` to initialize]).
====
