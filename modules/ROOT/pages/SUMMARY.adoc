...
. xref:ShuffleManager.adoc[ShuffleManager Contract -- Pluggable Shuffle Systems]
...
. link:ShuffleWriter.adoc[ShuffleWriter Contract]
...
. link:ShuffleBlockResolver.adoc[ShuffleBlockResolver]
...
. link:FetchFailedException.adoc[FetchFailedException]
...
.. xref:storage:StorageLevel.adoc[StorageLevel]
...
. link:ShuffleBlockFetcherIterator.adoc[ShuffleBlockFetcherIterator]
. link:spark-ExternalSorter.adoc[ExternalSorter]

. xref:ROOT:BlockManager.adoc[BlockManager -- Key-Value Store of Blocks of Data]
.. xref:storage:MemoryStore.adoc[MemoryStore]
...
.. link:BlockManagerMaster.adoc[BlockManagerMaster -- BlockManager for Driver]
... link:spark-blockmanager-BlockManagerMasterEndpoint.adoc[BlockManagerMasterEndpoint -- BlockManagerMaster RPC Endpoint]
.. link:DiskBlockManager.adoc[DiskBlockManager]
