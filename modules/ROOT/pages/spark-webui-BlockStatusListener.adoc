...
`BlockStatusListener` is a link:spark-scheduler-SparkListener.adoc[SparkListener] that tracks link:spark-BlockManager.adoc[BlockManagers] and the blocks for link:spark-webui-storage.adoc[Storage tab] in web UI.
