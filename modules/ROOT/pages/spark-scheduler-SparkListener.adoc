...
You can develop your own custom `SparkListener` and register it using xref:ROOT:SparkContext.adoc#addSparkListener[SparkContext.addSparkListener] method or link:spark-scheduler-LiveListenerBus.adoc#spark_extraListeners[spark.extraListeners] Spark property.
