...
* The given shuffleId is the xref:rdd:spark-rdd-ShuffleDependency.adoc#shuffleId[shuffleId] of the xref:rdd:spark-rdd-ShuffleDependency.adoc[ShuffleDependency] of the xref:scheduler:ShuffleMapStage.adoc#shuffleDep[ShuffleMapStage] (for which the ShuffleMapTask completed)
