...
== [[REDUCER_PREF_LOCS_FRACTION]] Map Output Threshold for Preferred Location of Reduce Task
...
* [[spark.shuffle.reduceLocality.enabled]] xref:ROOT:spark-configuration-properties.adoc#spark.shuffle.reduceLocality.enabled[spark.shuffle.reduceLocality.enabled]
...
== [[getPreferredLocationsForShuffle]] Finding Preferred Locations (with Most Shuffle Map Outputs)
