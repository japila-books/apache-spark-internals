...
== [[getPreferredLocationsForShuffle]] Finding Preferred BlockManagers with Most Shuffle Map Outputs
...
getStatistics is used when...FIXME

== [[unregisterAllMapOutput]] Unregistering All Map Outputs of Shuffle Stage
