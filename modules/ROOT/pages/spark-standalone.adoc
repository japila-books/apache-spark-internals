...
It requires a link:spark-scheduler-TaskScheduler.adoc[Task Scheduler], a link:spark-SparkContext.adoc[Spark context], and a collection of link:spark-deployment-environments.adoc#master-urls[master URLs].
