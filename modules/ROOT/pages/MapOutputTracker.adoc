...
serializeMapStatuses is used when ShuffleStatus is requested to xref:ROOT:ShuffleStatus.adoc#serializedMapStatus[serialize shuffle map output statuses].
