...
Used in `ExternalSorter`, link:spark-shuffle-BypassMergeSortShuffleWriter.adoc[BypassMergeSortShuffleWriter] and `ExternalAppendOnlyMap` (for `fileBufferSize`) and in link:spark-shuffle-ShuffleExternalSorter.adoc[ShuffleExternalSorter] (for link:spark-shuffle-ShuffleExternalSorter.adoc#fileBufferSizeBytes[fileBufferSizeBytes]).
