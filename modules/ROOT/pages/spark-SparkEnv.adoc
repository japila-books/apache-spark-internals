...
`create` creates a xref:ROOT:MapOutputTrackerMaster.adoc[MapOutputTrackerMaster] or xref:ROOT:MapOutputTrackerWorker.adoc[MapOutputTrackerWorker] for the driver and executors, respectively.
