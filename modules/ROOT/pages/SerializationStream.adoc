...
* SerializerManager is requested to xref:ROOT:spark-SerializerManager.adoc#dataSerializeStream[dataSerializeStream] and xref:ROOT:spark-SerializerManager.adoc#dataSerializeWithExplicitClassTag[dataSerializeWithExplicitClassTag]
