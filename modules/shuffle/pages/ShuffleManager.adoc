...
Used exclusively when `ShuffleMapTask` is requested to xref:scheduler:spark-scheduler-ShuffleMapTask.adoc#runTask[run] (and requests the <<ShuffleWriter.adoc#, ShuffleWriter>> to write records for a partition)
