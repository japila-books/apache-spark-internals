...
ShuffleWriter is used when xref:scheduler:spark-scheduler-ShuffleMapTask.adoc[ShuffleMapTask] is requested to xref:scheduler:spark-scheduler-ShuffleMapTask.adoc#runTask[run].
...
stop is used when ShuffleMapTask is requested to xref:scheduler:spark-scheduler-ShuffleMapTask.adoc#runTask[run].
...
write is used when `ShuffleMapTask` is requested to xref:scheduler:spark-scheduler-ShuffleMapTask.adoc#runTask[run].
