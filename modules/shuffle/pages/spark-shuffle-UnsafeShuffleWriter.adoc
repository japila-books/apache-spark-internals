...
`UnsafeShuffleWriter` is a xref:spark-shuffle-ShuffleWriter.adoc[ShuffleWriter] for xref:spark-shuffle-SerializedShuffleHandle.adoc[SerializedShuffleHandles]:
