...
`closeAndWriteOutput` creates a xref:scheduler:MapStatus.adoc[MapStatus] with the xref:ROOT:BlockManager.adoc#shuffleServerId[location of the executor's `BlockManager`] and partition lengths in the merged file.
