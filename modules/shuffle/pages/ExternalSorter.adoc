...
== [[buffer]][[map]] Collections of In-Memory Records
...
ExternalSorter <<maybeSpillCollection, maybeSpillCollection>> and, xref:shuffle:Spillable.adoc#maybeSpill[if spilled to disk], creates a new collection.
