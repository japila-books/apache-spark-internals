...
`ExecutorSource` is a link:spark-metrics-Source.adoc[metrics source] of an xref:core:Executor.adoc[]. It uses an executor's xref:core:Executor.adoc#threadPool[threadPool] for calculating the gauges.
