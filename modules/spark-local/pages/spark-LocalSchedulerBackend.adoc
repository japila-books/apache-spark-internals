...
`start` requests the <<listenerBus, LiveListenerBus>> to xref:scheduler:LiveListenerBus.adoc#post[post] a <<../spark-scheduler-SparkListener.adoc#SparkListenerExecutorAdded, SparkListenerExecutorAdded>> event.
