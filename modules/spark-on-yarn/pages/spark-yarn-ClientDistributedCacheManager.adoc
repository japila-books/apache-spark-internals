...
`updateConfiguration` sets the following internal Spark configuration settings in the input `conf` link:../SparkConf.md[Spark configuration]:
...
NOTE: It is later used in link:spark-yarn-applicationmaster.md#localResources[`ApplicationMaster` when it prepares local resources].
