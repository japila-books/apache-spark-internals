...
| link:spark-yarn-settings.adoc#spark.yarn.executor.memoryOverhead[spark.yarn.executor.memoryOverhead] and falls back to link:spark-yarn-YarnSparkHadoopUtil.adoc#MEMORY_OVERHEAD_FACTOR[10%] of the xref:executor:Executor.adoc#spark.executor.memory[spark.executor.memory] or link:spark-yarn-YarnSparkHadoopUtil.adoc#MEMORY_OVERHEAD_MIN[384] whatever is larger.
| FIXME
...
* Sets the internal `executorMemory` to xref:executor:Executor.adoc#spark.executor.memory[spark.executor.memory].
