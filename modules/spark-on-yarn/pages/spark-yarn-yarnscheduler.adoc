...
`YarnScheduler` is the xref:scheduler:TaskScheduler.adoc[TaskScheduler] for link:README.adoc[Spark on YARN] in link:spark-submit.adoc#deploy-mode[client deploy mode].
