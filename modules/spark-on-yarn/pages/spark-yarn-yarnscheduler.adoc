...
`YarnScheduler` is the xref:scheduler:TaskScheduler.md[TaskScheduler] for link:README.md[Spark on YARN] in link:spark-submit.md#deploy-mode[client deploy mode].
