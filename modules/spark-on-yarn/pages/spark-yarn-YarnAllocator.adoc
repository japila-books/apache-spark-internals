...
It sets the internal `executorMemory` to xref:core:Executor.adoc#spark.executor.memory[spark.executor.memory].
...
It sets the internal `executorCores` to xref:core:Executor.adoc#spark.executor.cores[spark.executor.cores].
