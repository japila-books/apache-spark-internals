...
Creating a `YarnClusterSchedulerBackend` object requires a xref:scheduler:TaskSchedulerImpl.adoc[TaskSchedulerImpl] and xref:ROOT:SparkContext.adoc[] objects.
