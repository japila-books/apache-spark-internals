...
NOTE: `start` is part of link:../spark-SchedulerBackend.adoc#contract[SchedulerBackend contract] executed when xref:scheduler:TaskSchedulerImpl.adoc#start[`TaskSchedulerImpl` starts].
