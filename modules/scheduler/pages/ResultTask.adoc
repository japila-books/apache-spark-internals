...
<<creating-instance, `ResultTask` is created>> exclusively when xref:ROOT:DAGScheduler.adoc#submitMissingTasks[`DAGScheduler` submits missing tasks for a `ResultStage`].
