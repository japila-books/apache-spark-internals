...
NOTE: When `FIFOSchedulableBuilder` is created, the `TaskSchedulerImpl` passes its own `rootPool` (a part of link:spark-scheduler-TaskScheduler.adoc#contract[TaskScheduler Contract]).
