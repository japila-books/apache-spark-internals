...
* [[FAIR]] `FAIR` with a link:spark-scheduler-FairSchedulableBuilder.adoc#buildPools[hierarchy of `Schedulable` (sub)pools] with the xref:scheduler:TaskScheduler.adoc#rootPool[rootPool] at the top.
* [[NONE]] *NONE* (not used)
