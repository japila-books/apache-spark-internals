...
a| [[executorIdToTaskCount]] Lookup table of the number of running tasks by xref:core:Executor.adoc[].

| executorsByHost
a| [[executorsByHost]] Collection of xref:core:Executor.adoc[executors] per host
...
| taskIdToExecutorId
a| [[taskIdToExecutorId]] Lookup table of xref:core:Executor.adoc[] by task id.
