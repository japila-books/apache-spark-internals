...
NOTE: link:spark-rdd-NarrowDependency.adoc[NarrowDependency] and xref:rdd:ShuffleDependency.adoc.adoc[ShuffleDependency] are the two top-level subclasses of `Dependency` abstract class.
...
| xref:rdd:ShuffleDependency.adoc.adoc[ShuffleDependency] |
