== [[UnifiedMemoryManager]] UnifiedMemoryManager -- Spark's Memory Manager

`UnifiedMemoryManager` is the default link:MemoryManager.adoc[MemoryManager] with `onHeapStorageMemory` being ??? and `onHeapExecutionMemory` being ???
...
NOTE: `acquireStorageMemory` is part of the link:MemoryManager.adoc#acquireStorageMemory[MemoryManager Contract] to...FIXME
...
NOTE: `acquireUnrollMemory` is part of the link:MemoryManager.adoc#contract[`MemoryManager` Contract].
...
NOTE: `acquireExecutionMemory` is part of the link:MemoryManager.adoc#contract[`MemoryManager` Contract].
...
NOTE: `maxOnHeapStorageMemory` is part of the link:MemoryManager.adoc#contract[`MemoryManager` Contract].
