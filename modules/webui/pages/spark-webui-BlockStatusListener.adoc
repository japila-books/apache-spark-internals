...
| [[blockManagers]] `blockManagers` | The lookup table for a collection of xref:storage:BlockId.adoc[] and `BlockUIData` per xref:storage:BlockManager.adoc#BlockManagerId[BlockManagerId].
|===
