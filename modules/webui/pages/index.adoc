...
TIP: You can use the web UI after the application has finished by persisting events (using link:spark-SparkListener-EventLoggingListener.adoc[EventLoggingListener]) and using xref:spark-history-server:index.adoc[Spark History Server].
