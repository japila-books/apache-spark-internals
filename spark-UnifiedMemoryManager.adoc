...
| [[spark_testing_memory]] `spark.testing.memory` | Java's link:++https://docs.oracle.com/javase/8/docs/api/java/lang/Runtime.html#maxMemory--++[Runtime.getRuntime.maxMemory] |
| [[spark_testing_reservedMemory]] `spark.testing.reservedMemory` | `0` (when `spark.testing` set) or `300M` |
