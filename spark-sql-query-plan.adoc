...
You can find out about the schema of a `QueryPlan` using `schema` that builds link:spark-sql-dataframe.adoc#StructType[StructType] from the <<output, output attributes>>.
