...
Scala-specific, `QueryPlan` is an abstract class that is the base class of link:spark-sql-catalyst-SparkPlan.adoc[SparkPlan] and link:spark-sql-LogicalPlan.adoc[LogicalPlan] abstract classes.
