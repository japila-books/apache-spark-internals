...
`LogicalRelation` is a link:spark-sql-LogicalPlan.adoc#LeafNode[leaf logical operator] that is an adapter for link:spark-sql-BaseRelation.adoc[BaseRelation] in a link:spark-sql-LogicalPlan.adoc[logical query plan].
