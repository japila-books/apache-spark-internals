...
`Client` (package: `org.apache.spark.deploy.yarn`) is a handle to a YARN cluster to deploy link:spark-yarn-applicationmaster.adoc[ApplicationMaster] (for a Spark application submitted to a YARN cluster).
