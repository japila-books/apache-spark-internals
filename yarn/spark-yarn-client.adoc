...
=== [[loginFromKeytab]] loginFromKeytab
...
+
NOTE: `extraClassPath` corresponds to link:spark-driver.adoc#spark.driver.extraClassPath[spark.driver.extraClassPath] for the driver and link:spark-executor.adoc#spark_executor_extraClassPath[spark.executor.extraClassPath] for executors.
