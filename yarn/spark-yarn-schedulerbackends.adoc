...
There are currently two link:spark-scheduler-backends.adoc[SchedulerBackends] for link:README.adoc[Spark on YARN] per link:spark-submit.adoc#deploy-mode[deploy mode]:
