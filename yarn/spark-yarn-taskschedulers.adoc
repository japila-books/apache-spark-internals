...
There are currently two link:spark-taskscheduler.adoc[TaskSchedulers] for link:README.adoc[Spark on YARN] per link:spark-submit.adoc#deploy-mode[deploy mode]:
