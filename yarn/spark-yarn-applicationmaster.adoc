...
=== [[runDriver]] Running Driver in Cluster Mode -- `runDriver` Internal Method
...
`runAMEndpoint` gives a `RpcEndpointRef` to the driver's `YarnScheduler` endpoint and registers *YarnAM* endpoint.
