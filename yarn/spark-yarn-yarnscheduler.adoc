...
`YarnScheduler` is the link:spark-taskscheduler.adoc[TaskScheduler] for link:yarn/README.adoc[Spark on YARN] in link:spark-submit.adoc#deploy-mode[client deploy mode].
