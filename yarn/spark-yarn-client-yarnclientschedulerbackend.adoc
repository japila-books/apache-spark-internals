...
NOTE: `hostport` is link:../spark-driver.adoc#spark_driver_host[spark.driver.host] and link:../spark-driver.adoc#spark_driver_port[spark.driver.port] Spark properties separated by `:`, e.g. `192.168.99.1:64905`.
