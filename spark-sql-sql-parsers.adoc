...
*SQL Parser Framework* in Spark SQL uses ANTLR to parse a SQL text and then creates link:spark-sql-DataType.adoc[data types], Catalyst's `Expression`, `TableIdentifier`, and link:spark-sql-logical-plan.adoc[LogicalPlan].
