...
*SQL Parser Framework* in Spark SQL uses ANTLR to parse a SQL text and create a `DataType`, `Expression`, `TableIdentifier`, or link:spark-sql-logical-plan.adoc[LogicalPlan] out of it.
