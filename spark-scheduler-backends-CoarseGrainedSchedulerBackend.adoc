...
| [[spark.default.parallelism]] `spark.default.parallelism` | Maximum of `totalCoreCount` and `2` | link:spark-scheduler-backends.adoc#defaultParallelism[Default parallelism] for the scheduler backend.
