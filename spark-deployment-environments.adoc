...
You use a master URL with link:spark-submit.adoc[spark-submit as the value of `--master` command-line option] or <<creating-sparkcontext, when creating SparkContext using `setMaster` method>>.
