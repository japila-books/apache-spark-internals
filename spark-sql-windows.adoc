...
*Windowed Aggregate Functions* (aka *window functions*) are functions that perform a calculation on a group of records (called a *window*) that are in _some_ relation to the current record.
