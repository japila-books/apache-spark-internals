...
*Spark Metrics* gives you execution metrics of a link:spark-metrics-MetricsSystem.adoc#subsystems[Spark subsystem] (aka _metrics instance_), e.g. link:spark-dagscheduler.adoc[DAGScheduler], link:spark-blockmanager.adoc[BlockManager], link:spark-Executor.adoc[Executor], link:spark-ExecutorAllocationManager.adoc[ExecutorAllocationManager], link:spark-ExternalShuffleService.adoc[ExternalShuffleService], etc.
