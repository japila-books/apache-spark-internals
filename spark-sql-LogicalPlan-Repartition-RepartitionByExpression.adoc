...
NOTE: link:spark-sql-BasicOperators.adoc[BasicOperators] strategy maps `RepartitionByExpression` to link:spark-sql-SparkPlan-ShuffleExchange.adoc[ShuffleExchange] physical operator with `HashPartitioning` expression.
