...
`AllJobsPage` is a page (in link:spark-webui-JobsTab.adoc[JobsTab]) that renders a summary, an event timeline, and active, completed, and failed jobs of a Spark application.
