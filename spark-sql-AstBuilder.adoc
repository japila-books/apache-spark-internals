...
a| link:spark-sql-Expression-WindowExpression.adoc#WithWindowDefinition[WithWindowDefinition] for link:spark-sql-functions-windows.adoc[windowed aggregates] (given `WINDOW` definitions).
