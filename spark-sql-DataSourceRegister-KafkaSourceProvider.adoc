...
`KafkaSourceProvider` is a link:spark-sql-datasource.adoc#CreatableRelationProvider[CreatableRelationProvider] and link:spark-sql-datasource.adoc#RelationProvider[RelationProvider].
