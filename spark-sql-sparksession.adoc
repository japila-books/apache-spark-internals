...
.SparkSession (and Builder) Class and Instance Methods
[frame="topbot",cols="1,2",options="header",width="100%"]
|======================
| Method | Description
| <<builder, builder>> | Use `SparkSession.builder` to build a `SparkSession` instance.
| <<enableHiveSupport, enableHiveSupport>> | Enables Hive support in the `SparkSession` being built (using <<builder, builder>>).
...
`enableHiveSupport` enables Hive support in the `SparkSession` being built (using the <<builder, fluent interface of `builder`>>).
