...
[CAUTION]
====
Review https://github.com/apache/spark/blob/master/core/src/main/scala/org/apache/spark/scheduler/cluster/mesos/MesosClusterScheduler.scala[MesosClusterScheduler.scala] class. There are some variables/properties used.
====

* _a scheduler of schedulers_
* _distributed systems kernel_
