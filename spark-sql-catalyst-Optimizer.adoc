...
`Optimizer` is a link:spark-sql-Analyzer.adoc#RuleExecutor[RuleExecutor] for link:spark-sql-LogicalPlan.adoc[logical plans]. It uses a <<batches, collection of logical plan optimizations>>.
