...
`EliminateSerialization` is a link:spark-sql-Analyzer.adoc#Rule[optimization rule] for a link:spark-sql-LogicalPlan.adoc[logical plan] in link:spark-sql-catalyst-Optimizer.adoc#SparkOptimizer[SparkOptimizer].
