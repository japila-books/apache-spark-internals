...
`HeartbeatReceiver` link:spark-rpc.adoc[RPC endpoint] is a link:spark-rpc.adoc#ThreadSafeRpcEndpoint[ThreadSafeRpcEndpoint] and a link:spark-scheduler-listeners.adoc#SparkListener[SparkListener].
