...
`SparkListenerBlockManagerAdded` is posted to inform that link:spark-blockmanager-BlockManagerMasterEndpoint.adoc#RegisterBlockManager-register[`BlockManagerMasterEndpoint` has registered a `BlockManager`].
...
`SparkListenerBlockManagerRemoved` is posted to inform that link:spark-blockmanager-BlockManagerMasterEndpoint.adoc#removeBlockManager[`BlockManagerMasterEndpoint` has removed a `BlockManager`].
...
`SparkListenerBlockUpdated` is posted to inform that link:spark-blockmanager-BlockManagerMasterEndpoint.adoc[`BlockManagerMasterEndpoint` has received a `UpdateBlockInfo` message].
