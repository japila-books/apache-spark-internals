...
The following are the built-in Spark listeners:
...
* `BlockStatusListener` and `StorageListener` for web UI.
...
* link:spark-webui-SQLListener.adoc[SQLListener] and link:spark-HistoryServer-SQLHistoryListener.adoc[SQLHistoryListener] for link:spark-HistoryServer.adoc[History Server].
