...
NOTE: It creates an unnamed  link:spark-taskscheduler.adoc#Pool[Pool] with scheduling mode as <<spark.scheduler.mode, spark.scheduler.mode>> or `FIFO`. See <<scheduling-mode, Scheduling Modes>> in this document.
