...
NOTE: `getSchedulableByName` is part of the <<spark-taskscheduler-Schedulable.adoc#getSchedulableByName, Schedulable Contract>> to find a <<spark-taskscheduler-Schedulable.adoc#, Schedulable>> by name.
