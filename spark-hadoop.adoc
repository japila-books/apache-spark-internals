...
NOTE: This page is the place to keep information more general about Hadoop and not related to link:spark-yarn.adoc[Spark on YARN] or files link:spark-files.adoc[Using Files] (HDFS). I don't really know what it could be, though. Perhaps nothing at all. Just saying.
