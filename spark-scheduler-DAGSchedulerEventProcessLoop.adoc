...
`handleGetTaskResult` merely posts link:spark-scheduler-SparkListener.adoc#SparkListenerTaskGettingResult[SparkListenerTaskGettingResult] (to link:spark-scheduler-DAGScheduler.adoc#listenerBus[`LiveListenerBus` Event Bus]).
...
Ultimately, `handleMapStageSubmitted` posts link:spark-scheduler-SparkListener.adoc#SparkListenerJobStart[SparkListenerJobStart] message to link:spark-scheduler-LiveListenerBus.adoc[LiveListenerBus] and link:spark-scheduler-DAGScheduler.adoc#submitStage[submits the `ShuffleMapStage`].
...
Ultimately, `handleJobSubmitted` posts  link:spark-scheduler-SparkListener.adoc#SparkListenerJobStart[SparkListenerJobStart] message to link:spark-scheduler-LiveListenerBus.adoc[LiveListenerBus] and link:spark-scheduler-DAGScheduler.adoc#submitStage[submits the stage].
