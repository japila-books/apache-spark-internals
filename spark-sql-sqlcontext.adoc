...
`SQLHistoryListener` is a custom link:spark-webui-SQLListener.adoc[SQLListener] for rendering the SQL UI in the link:spark-HistoryServer.adoc[History Server] with custom callback methods:
