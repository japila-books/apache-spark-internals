...
`ColumnPruning` is a link:spark-sql-Optimizer.adoc#ColumnPruning[logical optimization] (aka `Rule[LogicalPlan]`) in link:spark-sql-Optimizer.adoc[Optimizer] that...FIXME
