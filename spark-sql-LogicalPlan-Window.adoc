...
* a collection of link:spark-sql-catalyst-Expression.adoc#NamedExpression[named expressions] (for windows)
* a collection of link:spark-sql-catalyst-Expression.adoc[expressions] (for partitions)
