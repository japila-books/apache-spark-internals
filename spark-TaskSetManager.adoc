...
NOTE: `canFetchMoreResults` is used exclusively when `TaskResultGetter` is requested to  link:spark-taskschedulerimpl-TaskResultGetter.adoc#enqueueSuccessfulTask[enqueue a successful task].
