...
A *DataFrame* in Spark SQL is *a distributed collection of structured data organized into named columns*. It is equivalent to a relational table and provides operations to filter, group, or compute aggregates, or convert to a RDD.
