...
It uses the immutable, in-memory, resilient, distributed and parallel capabilities of link:spark-rdd.adoc[RDD], and applies a link:spark-sql-schema.adoc[schema] to the data.
