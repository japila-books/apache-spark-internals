...
Used in link:spark-webui-jobs.adoc#AllJobsPage[Jobs tab] (for the Scheduling Mode), and to display pools in link:spark-webui-JobsTab.adoc[JobsTab] and link:spark-webui-StagesTab.adoc[StagesTab].
