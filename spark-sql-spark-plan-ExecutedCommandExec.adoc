...
`ExecutedCommandExec` is a link:spark-sql-catalyst-SparkPlan.adoc[SparkPlan] for executing link:spark-sql-LogicalPlan.adoc#RunnableCommand[logical commands with side effects].
