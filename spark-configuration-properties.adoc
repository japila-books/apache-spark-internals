...
a| [[spark.shuffle.manager]] Specifies the fully-qualified class name or the alias of the <<spark-shuffle-ShuffleManager.adoc#, ShuffleManager>> in a Spark application
