...
NOTE: link:spark-taskscheduler.adoc[TaskScheduler] and link:spark-scheduler-backends.adoc[SchedulerBackend] (with link:spark-dagscheduler.adoc[DAGScheduler]) are commonly referred to as *scheduling components*.
