...
You can start History Server by executing <<starting, `start-history-server.sh`>> shell script and stop the instance using <<stop_history_server_sh, `stop-history-server.sh`>>.
