...
`EnsureRequirements` is a link:spark-sql-Analyzer.adoc#Rule[optimization rule] for a link:spark-sql-SparkPlan.adoc[physical plan] in link:spark-sql-query-execution.adoc#preparations[QueryExecution].
