...
`EnsureRequirements` is a link:spark-sql-catalyst-analyzer.adoc#Rule[preparation rule] for a link:spark-sql-catalyst-SparkPlan.adoc[physical plan] in link:spark-sql-query-execution.adoc#preparations[QueryExecution].
