...
It is fair to say that a Dataset is a result of executing a SQL query against data storage like files or databases. The SQL query can be described by a SQL string or a Scala/Java lambda function.
