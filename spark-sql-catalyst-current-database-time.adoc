...
<<GetCurrentDatabase, GetCurrentDatabase>> and <<ComputeCurrentTime, ComputeCurrentTime>> optimization rules are part of *Finish Analysis* link:spark-sql-Analyzer.adoc#batch[batch] in the base link:spark-sql-catalyst-Optimizer.adoc[Optimizer].
