...
A SparkListenerJobStart event is posted to link:spark-LiveListenerBus.adoc[LiveListenerBus] (so other event listeners know about the event - not only DAGScheduler).
...
`SparkListenerJobStart` event is posted to link:spark-LiveListenerBus.adoc[LiveListenerBus].
...
`SparkListenerTaskEnd` is posted on link:spark-LiveListenerBus.adoc[LiveListenerBus].
...
* `SparkListenerJobEnd` is posted on link:spark-LiveListenerBus.adoc[LiveListenerBus] with `JobSucceeded`
