...
It calls <<submitJob, submitJob>> and then waits until a result comes using a link:spark-dagscheduler-JobListener.adoc#JobWaiter[JobWaiter] object. A job can succeed or fail.
