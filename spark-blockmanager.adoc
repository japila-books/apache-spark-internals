...
When a new broadcast value is created, link:spark-service-broadcastmanager.adoc#TorrentBroadcast[TorrentBroadcast] blocks are put in the block manager.
...
The setting is also used in link:spark-service-broadcastmanager.adoc#settings[TorrentBroadcast].
