...
`StructType` is a built-in link:spark-sql-DataType.adoc[data type] in Spark SQL to represent a collection of link:spark-sql-StructField.adoc[StructField]s that together define a schema.
