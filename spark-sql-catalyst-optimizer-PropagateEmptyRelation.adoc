...
`PropagateEmptyRelation` is a part of *LocalRelation* link:spark-sql-catalyst-analyzer.adoc#batch[batch] in the base link:spark-sql-catalyst-Optimizer.adoc[Optimizer].
