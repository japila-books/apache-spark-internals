...
NOTE: There are two custom `SparkListenerBus` listeners: link:spark-scheduler-LiveListenerBus.adoc[LiveListenerBus] and link:spark-SparkListenerBus-ReplayListenerBus.adoc[ReplayListenerBus].
