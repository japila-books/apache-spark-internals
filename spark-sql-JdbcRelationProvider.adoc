...
`JdbcRelationProvider` is a link:spark-sql-CreatableRelationProvider.adoc[CreatableRelationProvider] and link:spark-sql-DataSource.adoc#RelationProvider[RelationProvider] that link:spark-sql-DataSourceRegister.adoc[handles data sources] for link:spark-sql-DataFrameReader.adoc#jdbc[jdbc] format.
