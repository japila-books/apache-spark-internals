...
`JdbcRelationProvider` is a link:spark-sql-datasource.adoc#CreatableRelationProvider[CreatableRelationProvider] and link:spark-sql-datasource.adoc#RelationProvider[RelationProvider] that link:spark-sql-DataSourceRegister.adoc[handles data sources] for link:spark-sql-DataFrameReader.adoc#jdbc[jdbc] format.
