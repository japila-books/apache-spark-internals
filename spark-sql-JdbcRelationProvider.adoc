...
`JdbcRelationProvider` is a link:spark-sql-datasource.adoc#CreatableRelationProvider[CreatableRelationProvider] and link:spark-sql-datasource.adoc#RelationProvider[RelationProvider] that link:spark-sql-DataSourceRegister.adoc[handles data sources] using link:spark-sql-DataFrameReader.adoc#jdbc[jdbc] format.
...
In the end, `createRelation` creates a link:spark-sql-JDBCRelation.adoc[JDBCRelation] using link:spark-sql-JDBCRelation.adoc#columnPartition[column partitions] (and link:spark-sql-DataFrameReader.adoc#JDBCOptions[JDBCOptions]).
...
NOTE: `createRelation` is a part of link:spark-sql-datasource.adoc#CreatableRelationProvider[CreatableRelationProvider Contract].
