...
* (Spark Core) link:spark-rdd-blockrdd.adoc[BlockRDD], `CoalescedRDD`, link:spark-rdd-hadooprdd.adoc[HadoopRDD], `NewHadoopRDD`, link:spark-rdd-parallelcollectionrdd.adoc[ParallelCollectionRDD], `ReliableCheckpointRDD`, link:spark-rdd-ShuffledRDD.adoc[ShuffledRDD]
