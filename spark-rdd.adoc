...
* (Spark Core) link:spark-streaming-BlockRDD.adoc[BlockRDD], `CoalescedRDD`, link:spark-rdd-hadooprdd.adoc[HadoopRDD], link:spark-rdd-NewHadoopRDD.adoc[NewHadoopRDD], link:spark-rdd-parallelcollectionrdd.adoc[ParallelCollectionRDD], `ReliableCheckpointRDD`, link:spark-rdd-ShuffledRDD.adoc[ShuffledRDD]
