...
A *ShuffleMapTask* divides the elements of an RDD into multiple buckets (based on a partitioner specified in link:spark-rdd-ShuffleDependency.adoc[ShuffleDependency]).
