== [[UnsafeProjection]] UnsafeProjection -- Projecting InternalRows to UnsafeRows

`UnsafeProjection` is a `Projection` function that takes link:spark-sql-InternalRow.adoc[InternalRow] and generates link:spark-sql-UnsafeRow.adoc[UnsafeRow].
