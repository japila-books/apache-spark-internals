...
`BlockManagerMasterEndpoint` is the link:spark-rpc-RpcEndpoint.adoc[RpcEndpoint] for link:spark-BlockManagerMaster.adoc[BlockManagerMaster] under *BlockManagerMaster* name.
