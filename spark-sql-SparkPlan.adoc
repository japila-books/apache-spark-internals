...
a| Required *partition requirements* (_aka_ *child output distributions*) of the input data (from link:spark-sql-catalyst-TreeNode.adoc#children[children] operators)
