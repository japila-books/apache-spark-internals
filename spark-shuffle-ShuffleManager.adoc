...
[[implementations]]
NOTE: <<spark-shuffle-SortShuffleManager.adoc#, SortShuffleManager>> (short name: `sort` or `tungsten-sort`) is the default implementation of the <<contract, ShuffleManager Contract>> in Apache Spark.
