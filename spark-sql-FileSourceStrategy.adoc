...
`FileSourceStrategy` is a `Strategy` that uses a <<PhysicalOperation, PhysicalOperation>> to destructure and then optimize a link:spark-sql-LogicalPlan.adoc[LogicalPlan].
