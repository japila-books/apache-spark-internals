...
A *ShuffleDependency* represents a dependency on the output of link:spark-scheduler.adoc#ShuffleMapStage[a shuffle map stage] for a RDD when a job is submitted to link:spark-scheduler.adoc[DAGScheduler] for execution.
