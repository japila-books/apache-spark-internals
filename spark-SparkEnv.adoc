...
`create` creates a link:spark-shuffle-ShuffleManager.adoc[ShuffleManager] based on link:spark-shuffle-ShuffleManager.adoc#spark_shuffle_manager[spark.shuffle.manager] Spark property.
